...
namespace PixelCrushers.DialogueSystem
{
    ...
    {
        public string mouseTag = "joystickWorldFollower";
        /// <summary>
        ...
        /// <summary>
        /// Determines, whether the usable was triggered and clicked on.
        /// </summary>
        private bool clicked;

        /// <summary>
        /// Determines, whether the usable was triggered with the correct tag.
        /// </summary>
        ...
        {
            triggered = other.gameObject.CompareTag(mouseTag);
        }
